...
Num1 = float(input("Ingrese el seundo valor: "))#Pedimos los valores para comparar
...
#Comparo su calificacion, dependiendo que valor me de sera el mensaje que me enviara el programa
if Cal < 0:
    ...
    print('Suficiente. Reprobaste cagada, eres una mierda que no vale nada, echale ganas, apoco quieres recursar')
elif Cal == 6:
